  ...
  return (
    <main className="min-h-screen bg-black text-white overflow-x-hidden relative">
      ...
      <div className="relative">
        {/* Brilho vermelho subindo por trás do card no mobile */}
        <div className="absolute -top-16 left-1/2 -translate-x-1/2 w-[120%] h-40 bg-primary/20 blur-[90px] z-10 md:hidden pointer-events-none"></div>
        
        <section className="pt-12 pb-16 md:py-16 bg-black rounded-t-[3rem] md:rounded-t-none relative z-20 -mt-12">
          <div className="container mx-auto px-4 md:px-12 mb-6 md:mb-12 text-center">
            <h2 className="text-3xl md:text-5xl font-black text-white tracking-tighter">
              Na <span className="text-primary">DVNFLIX</span>, você tem acesso a:
            </h2>
          </div>

          <div className="space-y-4">
            <ContentCarousel title={<>Jogos ao vivo e <span className="text-primary font-black">MUITO MAIS</span>:</>} items={sportsItems} delay={0} />
            <ContentCarousel title={<>Principais <span className="text-primary font-black">FILMES</span>:</>} items={moviesItems} delay={2} />
            <ContentCarousel title={<>Melhores <span className="text-primary font-black">SÉRIES</span>:</>} items={seriesItems} delay={4} />
          </div>
        </section>
      </div>
