                ...
                >
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-400 text-sm">
                            Identificamos seu pagamento! Um e-mail com instruções para você também foi enviado para:
                        </p>
                        <div className="bg-white/5 border border-white/10 p-4 rounded-xl font-bold text-white text-lg">
                            {formData.email}
                        </div>
                        <p className="text-[10px] text-gray-500 uppercase font-medium mt-2">(Verifique sua caixa de entrada e SPAM).</p>
                    </div>
            ...
            <div className="w-full max-w-md bg-[#0f0f0f] border border-white/10 rounded-[3rem] p-8 md:p-12 shadow-2xl relative overflow-hidden">
                ...
                <div className="text-center mb-10 relative z-10">
                    <div className="relative w-40 h-12 mx-auto mb-4">
                        <Image src="https://i.imgur.com/MD1ffQ7.png" alt="DvnFlix" fill className="object-contain" unoptimized />
                    </div>
                    ...
                    {step === 0 ? (
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-primary/10 border border-primary/20 p-5 rounded-2xl max-w-sm mx-auto">
                                    <p className="text-lg text-primary font-black uppercase tracking-wide leading-relaxed">
                                        Irei chamar você via WhatsApp dentro de 5 minutos para passar o seu acesso.
                                    </p>
                                </div>
                            ...
                            <div className="flex flex-col gap-3 max-w-xs mx-auto pt-6">
                                <button
                                    onClick={() => router.push('/')}
                                    className="w-full bg-white/5 border border-white/10 text-gray-400 font-black py-4 rounded-xl hover:bg-white/10 transition-all uppercase tracking-widest text-[11px]"
                                >
...
const testimonials = [
    ...
    { name: 'André Luiz', text: 'O acesso é real, já uso há meses e nunca tive problemas. Recomendo d+.' },
