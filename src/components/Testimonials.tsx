...
export default function Testimonials() {
    return (
        <section className="pt-8 pb-6 bg-black relative overflow-hidden">
            {/* Cinematic Atmosfera */}
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="relative w-full overflow-hidden">
                    {/* SOMBRAS LATERAIS */}
                    <div className="hidden md:block absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-black via-black/70 to-transparent z-10 pointer-events-none" />
                    <div className="hidden md:block absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-black via-black/70 to-transparent z-10 pointer-events-none" />
                ...
                <div className="mt-6 text-center space-y-4">
                    ...
                    <p className="text-[11px] font-black uppercase tracking-[0.5em] text-white italic">Junte-se aos +{testimonials.length * 1000} clientes satisfeitos</p>
                    <div className="flex justify-center gap-1">
                        {[...Array(5)].map((_, i) => <Star key={i} size={14} className="text-white fill-white opacity-40" />)}
                    </div>
                </div>
            </div>
        </section>
