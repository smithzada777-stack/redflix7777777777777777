            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="flex md:hidden flex-col gap-8 items-center justify-center max-w-sm mx-auto">
                    ...
                    <div className="relative w-full">
                        <div className="absolute -top-4 left-1/2 -translate-x-1/2 z-20 bg-primary text-white px-4 py-1 rounded-full text-[9px] font-black uppercase tracking-wider shadow-lg border-2 border-red-400">NA DVNFLIX</div>
                ...
                <div className="hidden md:flex gap-12 items-center justify-center max-w-6xl mx-auto">
                    ...
                    <div className="relative w-full max-w-sm">
                        <div className="absolute -top-5 left-1/2 -translate-x-1/2 z-20 bg-primary text-white px-5 py-2 rounded-full text-xs font-black uppercase tracking-wider shadow-[0_0_20px_rgba(229,9,20,0.4)] transform rotate-2 border-2 border-[#ff4d4d]">NA DVNFLIX</div>
