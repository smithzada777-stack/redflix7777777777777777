...
const faqs = [
    ...
    { q: 'Preciso ficar preso a um contrato de fidelidade?', a: 'Não! Na DvnFlix a liberdade é sua. Você assina e cancela quando quiser, sem multas e sem letras miúdas.' },
