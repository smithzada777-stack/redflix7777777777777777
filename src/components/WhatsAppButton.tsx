...
export default function WhatsAppButton() {
    ...
    useEffect(() => {
        // A mensagem aparece depois de 4 segundos
        ...
        <div className="fixed right-6 bottom-6 z-50 flex items-center justify-end">
            ...
            <div
                className={`
                    ...
                    bg-primary text-white h-14 md:h-16 px-8 md:px-10 rounded-full shadow-2xl shadow-primary/40
                    ...
                    ${showTooltip
                        ? 'opacity-100 translate-x-[-80px] md:translate-x-[-80px] scale-100 pointer-events-auto'
                        : 'opacity-0 translate-x-0 scale-0 pointer-events-none'
                    }
                `}
            >
                <span className="font-bold text-xs md:text-sm tracking-tight text-white">
